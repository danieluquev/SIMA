...
const data = require("../../BD/Offline/Vert_Sulf.csv");

export default function VertSulf() {
  ...
  const [options, setOptions] = useState({
    ...
    title: {
      text: "Discharge Sulphates - Ponds And Reservoir LMN",
      left: "center",
    },
    toolbox: {
      // y: 'bottom',
  ...
  useEffect(() => {
    ...
    csv(data).then((data) => {
      ...
      let limite = new Array (verts['Fecha'].length).fill(1800)
      ...
      series.push(
        {
            ...
            markLine: {
                data: [
                    {name: 'Limite Sulfatos', yAxis: 1200, label: {formatter: 'Limit Sulphates (Res. 631/15)', position: 'insideStartTop'}}
                ],
                symbol: 'none',
